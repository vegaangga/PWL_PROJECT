            ...
            <div class="card-body">
                ...
                @endif
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="no_telp" name="no_telp" class="form-control" id="no_telp" aria-describedby="no_telp" value="{{ $data->no_telp}}" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="date" name="tgl_lahir" class="form-control" id="tgl_lahir" aria-describedby="tgl_lahir" value="{{ $data->tgl_lahir}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" name="tempat_lahir" class="form-control" id="tempat_lahir" aria-describedby="tempat_lahir" value="{{ $data->tempat_lahir}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" name="alamat" class="form-control" id="alamat" aria-describedby="alamat" value="{{ $data->alamat}}" >
                            </div>
                        </div>
                    </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                <input type="text" name="asal_sekolah" class="form-control" id="Nim" aria-describedby="add_ijazah" value="{{ $data->asal_sekolah}}" >
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="file" name="add_ijazah" class="form-control" id="foto" aria-describedby="foto" >
                            </div>
                        </div>
                    </div>
            </div>
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <select class="form-control" name="status_ayah" required="" value="{{ $data->status_ayah}}" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="nama_ayah" class="form-control" id="nama_ayah" aria-describedby="nama_ayah" value="{{ $data->nama_ayah}}" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="nik_ayah" class="form-control" id="nik_ayah" aria-describedby="nik_ayah" value="{{ $data->nik_ayah}}" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="pekerjaan_ayah" class="form-control" id="pekerjaan_ayah" aria-describedby="pekerjaan_ayah" value="{{ $data->pekerjaan_ayah}}" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="gaji_ayah" class="form-control" id="gaji_ayah" aria-describedby="gaji_ayah" placeholder="Perbulan" value="{{ $data->gaji_ayah}}" >
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <select class="form-control" name="status_ibu" required value="{{ $data->status_ibu}}" >
                                        <option value="H">Masih Hidup</option>
                                        <option value="M">Sudah Meninggal</option>
                                    </select>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="nama_ibu" class="form-control" id="nama_ayah" aria-describedby="nama_ayah" value="{{ $data->nama_ibu}}" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="nik_ibu" class="form-control" id="nik_ayah" aria-describedby="nik_ayah" value="{{ $data->nik_ibu}}" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="pekerjaan_ibu" class="form-control" id="pekerjaan_ayah" aria-describedby="pekerjaan_ayah" value="{{ $data->pekerjaan_ibu}}" >
                                </div>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    <input type="text" name="gaji_ibu" class="form-control" id="gaji_ayah" aria-describedby="gaji_ayah" placeholder="Perbulan" value="{{ $data->gaji_ibu}}" >
                                </div>
                            </div>
                        </div>
